...
#    cv2.imshow("mask",mask)
    ...
    if conts and max_area > min_area and max_area2 > min_area:
        ...
        return best_cont, cx, cy, max_area, best_cont2, cx2, cy2, max_area2
    elif conts and max_area > min_area:
        M = cv2.moments(best_cont)
        cx,cy = int(M['m10']/M['m00']),int(M['m01']/M['m00'])
        return best_cont, cx, cy, max_area, 0,-1,-1,-1
    elif max_area2 > min_area:
        M2 = cv2.moments(best_cont2)
        cx2,cy2 = int(M2['m10']/M['m00']),int(M2['m01']/M['m00'])
        return 0,-1,-1,-1, best_cont2, cx2, cy2, max_area2
    else:
...
#    imgHSV_crop = imgHSV[200:280, 0:320]
    ...
    best_blackcont, blackcx_incrop, blackcy_incrop, blackarea, best_blackcont2, blackcx_incrop2, blackcy_incrop2, blackarea2 = FindColor(imgHSV_crop, lower_black, upper_black, 10)
