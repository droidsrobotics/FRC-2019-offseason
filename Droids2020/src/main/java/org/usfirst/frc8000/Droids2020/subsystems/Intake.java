...
public class Intake extends Subsystem {
    ...
    */
    public Intake() {
        intakeMotorLeft = new CANSparkMax(1, MotorType.kBrushless);
        intakeMotorRight = new CANSparkMax(1, MotorType.kBrushless);
        /*
        // BEGIN AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=CONSTRUCTORS
        intakeMotorLeft = new WPI_TalonSRX(5);
        
        
        
        intakeMotorRight = new WPI_TalonSRX(6);
