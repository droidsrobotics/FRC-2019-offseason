...
public class Lift extends Subsystem {
	...
	*/
    ...
    private static boolean limitSet; 
...
// -124 limit for folding
    ...
    public void setSpeed(double speed) {
        ...
        if (speed < 0.0) {
            ...
            } else if (limitSet && Robot.wrist.folded && high) {
                this.setRawSpeed(0.0);
            } else if (limitSet && (currentPosition < -230)) {
            ...
            if (limitSwitchDown.get() == false) { 
                this.setRawSpeed(0.0);
            } else if (limitSet && liftEncoder.getPosition() > -60) {
                this.setRawSpeed(speed * 0.25);
            } else {
                this.setRawSpeed(speed);
            }
