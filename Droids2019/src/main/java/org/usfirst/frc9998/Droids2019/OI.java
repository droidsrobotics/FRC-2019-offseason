...
public class OI {
    ...
    public JoystickButton xintakeconnectexpand;
    public JoystickButton aliftup;
    public JoystickButton bintakeconnectshrink;
    ...
    public OI() {
        ...
        bintakeconnectshrink = new JoystickButton(joystick2, 3);
        bintakeconnectshrink.whenPressed(new IntakeConnectSet(-0.1));
        aliftup = new JoystickButton(joystick2, 2);
        aliftup.whileHeld(new LiftRun(1.0));
        xintakeconnectexpand = new JoystickButton(joystick2, 1);
        xintakeconnectexpand.whenPressed(new IntakeConnectSet(0.1));
